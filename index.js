...
function copy(arrays1){
  var copyarrar = arrays1;
  console.log(copyarrar);
  return copyarrar;
}
...
function is31Flavors(arrars2){
   if (arrars2.length === 31){
     console.log("True", arrars2.length);
     return true;
   }
  else{
    console.log("False", arrars2.length);
    return false;
  }
}
...
function addFlavor(arrars3, string1){
  arrars3.unshift(string1);
  console.log(arrars3);
  return arrars3;
}
...
function removeLastFlavor(arrars4){
  arrars4.pop();
  console.log(arrars4);
  return arrars4;
}
...
function getFlavorByIndex(arrars5, num){
  console.log(arrars5[num]);
  return arrars5[num];
}
...
function removeFlavorByName(arrars6, string2){
  for(let i = 0; i < arrars6.length; i++){
    if (arrars6[i] === string2){
      arrars6.splice(i,1);
      console.log(arrars6);
      return arrars6;
    }
...
function filterByWord(arrars7, string3){
  var newarray = [];
  for(let i = 0; i < arrars7.length; i++){
    if (arrars7[i].includes(string3)){
      newarray.push(arrars7[i]);
    }
  }
